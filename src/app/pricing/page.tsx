    ...
    <div className="relative h-full w-full overflow-hidden">
      <main className="h-full w-full">
        <section id="hero" className="px-0 border-b">
          <Image
            src="/bg-hero.webp"
            className="hidden md:block absolute opacity-50 transition-opacity duration-500 pointer-events-none w-full select-none"
            alt="background"
            priority
            fill
          />
        ...
        <section id="pricing-breakdown">
          <div className="py-[--header-height] space-y-[--section-gap] relative w-full max-w-2xl mx-auto">
